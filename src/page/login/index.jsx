    ...
    return (
        <div className="z-20 w-full h-full flex justify-center py-10">
            <div className="no-scroll m-auto h-full overflow-auto w-[80vw] md:w-[70vw] lg:w-[70vw] flex flex-col items-center justify-start text-white p-4 pt-4 md:pt-10 lg:pt-10">
                ...
                <h1 style={{ fontFamily: "Proxima Nova" }} className="tabb text-4xl md:text-5xl xl:text-3xl font-bold text-center p-2 md:p-0 mb-4 2xl:text-5xl ">
                ...
                <div>
                    <div className="flex justify-end items-center mt-4 md:mt-12 lg:mt-4 2xl:mt-8">
                        <p style={{ fontFamily: "Proxima Nova" }} className="text-white mr-2 2xl:mr-8 text-xl md:text-2xl lg:text-xl 2xl:text-2xl">
                            Naam
                        </p>
                        <div className="relative h-[6vh] md:h-[6vh] lg:h-[40px] 2xl:h-[7vh]">
                            <img src={inputImage} alt="Gambar" className="w-40 md:w-80 2xl:w-[90%] h-full " />
